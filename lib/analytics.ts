 ...
 * `ANALYTICS_EVENTS` in @/lib/db is that place; nothing here restates a name, and the
...
/**
 * Built on the shared shape in @/lib/db rather than beside it, so the columns that
