...
export function getLaunchReadiness(): { supply: ReadinessGate[]; funnel: ReadinessGate[] } {
  return {
    supply: [
      ...
      {
        label: 'Real-wedding stories',
        value: 18,
        target: 50,
        hint: 'Seeded from the anchor studio',
      },
    ],
    funnel: [
      { label: 'Search → verified lead success', value: 97, target: 99, unit: '%' },
      {
        label: 'Median vendor response',
        value: 84,
        target: 120,
        unit: 'min',
        hint: 'Lower is better; target is a ceiling',
      },
...
export function getModerationQueue(): ModerationItem[] {
  return [
    m(
      'mq-1',
      'vendor',
      'Aperture & Co. — new listing',
      'Aperture & Co.',
      'Lucknow',
      2,
      'New listing submitted by field agent',
      ['first_listing'],
      -4,
      'pending',
    ),
    m(
      'mq-2',
      'review',
      '1★ review on Rangoli Banquets',
      'Rangoli Banquets',
      'Lucknow',
      1,
      'Reported by vendor as defamatory',
      ['vendor_reported', 'low_rating'],
      -2,
      'escalated',
    ),
    m(
    ...
    m(
      'mq-4',
      'vendor',
      'Moonlight Weddings — price band change',
      'Moonlight Weddings',
      'Delhi NCR',
      4,
      'Price band dropped 60% in one edit',
      ['price_anomaly'],
      6,
      'pending',
    ),
    m(
      'mq-5',
      'review',
      '5★ review with no booking history',
      'Kalyana Clicks',
      'Lucknow',
      1,
      'Booking gate passed but account is 2 days old',
      ['new_account'],
      -1,
      'escalated',
    ),
    m(
      'mq-6',
      'story',
      'Meera & Arjun, Tamarind Estate',
      'Lightleak Studio',
      'Lucknow',
      6,
      'Real-wedding story submitted',
      [],
      11,
      'pending',
    ),
    ...
    m(
      'mq-8',
      'vendor',
      'Grand Palace Banquets — claim request',
      'Grand Palace Banquets',
      'Delhi NCR',
      3,
      'Owner claiming a field-created profile',
      ['ownership_claim'],
      2,
      'pending',
    ),
    m(
      'mq-9',
      'package',
      'Package priced at ₹500/day',
      'Budget Clicks',
      'Lucknow',
      3,
      'Implausible per-day price',
      ['price_anomaly'],
      5,
      'pending',
    ),
    m(
      'mq-10',
      'media',
      'Watermarked images from another studio',
      'Royal Frames',
      'Delhi NCR',
      1,
      'Auto-flagged: foreign watermark detected',
      ['watermark', 'possible_theft'],
      -6,
      'escalated',
    ),
    m(
      'mq-11',
      'review',
      'Review mentions a phone number',
      'The Glow Room',
      'Lucknow',
      4,
      'Contact details in review body',
      ['contact_in_text'],
      8,
      'pending',
    ),
    m(
      'mq-12',
      'vendor',
      'Spice Route Catering — GSTIN updated',
      'Spice Route Catering',
      'Lucknow',
      6,
      'KYC re-verification needed',
      ['kyc'],
      16,
      'pending',
    ),
