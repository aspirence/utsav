 ...
 *
 * noindex: a sign-in form has nothing to offer a search result, and plan §12 wants the
 * crawl budget spent on listings.
 */
export const metadata: Metadata = {
  title: 'Sign in',
  description: 'Sign in to Utsava with your mobile number.',
...
export default async function LoginPage({
  ...
  return (
    <Container className="max-w-md py-16 sm:py-24">
      <h1 className="text-3xl leading-tight text-ink-900 sm:text-4xl">Sign in</h1>
