      ...
      <Container className="py-10">
        <div className="grid gap-10 lg:grid-cols-[1fr_340px]">
          ...
          <article>
            ...
            <h1 className="text-ink-900 mt-3 max-w-3xl text-3xl leading-[1.15] sm:text-4xl">
              {story.title}
            </h1>

            {story.subtitle && (
              <p className="text-ink-600 mt-4 max-w-2xl text-lg">{story.subtitle}</p>
            )}

            <p className="text-ink-500 mt-4 text-sm">{[where, when].filter(Boolean).join(' · ')}</p>
            ...
            <p className="border-ink-100 text-ink-500 mt-10 border-t pt-6 text-xs">
          ...
          <aside className="lg:sticky lg:top-24 lg:self-start">
            {vendor ? (
              <Card>
                <CardBody>
                  <p className="text-ink-500 text-xs tracking-wide uppercase">Shot by</p>
                  <h2 className="font-display text-ink-900 mt-1 text-2xl leading-tight">
                    {vendor.displayName}
                  </h2>
                  ...
                  <p className="text-ink-500 mt-5 text-xs tracking-wide uppercase">Price band</p>
                  <p className="font-display text-ink-900 mt-1 text-2xl">{vendor.priceBandLabel}</p>
              ...
              <Card>
                <CardBody>
                  <p className="font-display text-ink-900 text-xl">Planning something similar?</p>
